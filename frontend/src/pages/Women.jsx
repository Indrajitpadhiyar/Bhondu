...
const Women = () => {
  ...
  // Default Women's categories list (no Tournament Wear, added Full Outfit Dress, Sari, Kurti)
  const defaultWomenCategories = ['Full Outfit Dress', 'Sari', 'Kurti', 'T-Shirts', 'Shirts', 'Shoes'];

  // Extract other categories present in women's products, excluding 'Tournament Wear'
  const dbCategories = Array.from(new Set(
    products
      .flatMap(p => p.category)
      .filter(cat => cat && cat !== 'Tournament Wear')
  ));

  const uniqueCategories = Array.from(new Set([
    ...defaultWomenCategories,
    ...dbCategories
  ]));
